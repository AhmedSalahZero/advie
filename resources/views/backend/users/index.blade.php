                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-picture"></i>View Users ({{count($AllUsers)}})</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body">
                            ...
                            <div class="table-scrollable">
                                <table class="table table-condensed table-hover">
                                    ...
                                    <tbody>
                                    @include('backend.users.fetch-Data-By-Ajax')
                                    </tbody>
                                </table>
...
@section('js')
    <script>
        $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"/admin/users/paginate_by_ajax?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
