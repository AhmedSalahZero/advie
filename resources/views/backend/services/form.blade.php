@section('title') @if(isset($service->id)) Edit @else Create New @endif  Service @endsection
                    ...
                    <div class="tab-pane active" id="tab_0">
                        <div class="portlet box green">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-gift"></i> Services </div>
                                <div class="tools">
                            ...
                            <div class="portlet-body form">
                                <!-- BEGIN FORM-->
                                <form action="{{isset($service) ? route('services.update',$service->id) :route('services.store') }}" class="form-horizontal" method="post"  enctype="multipart/form-data">
                                    @csrf
                                    @if(isset($service))
                                        @method('put')
                                        @endif
                                    <div class="form-body">
                                        ...
                                        @foreach($AllLanguages as $one)
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <label for="title{{$one->name}}" class="col-md-3 control-label"> Service {{$one->name}} title
                                                            ...
                                                            <div class="col-md-6">
                                                                <input
                                                                    ...
                                                                    placeholder="Enter {{$one->name}} Service Title "
                                                                    value="{{isset($service) ? $service->title[$one->code] : old("title[$one->code]") }}"
                                                    ...
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        ...
                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                            <img
                                                                ...
                                                                @if(isset($service))
                                                                src="{{url('storage/'.$service->banner)}}"
                                                                @else
                                                                @endif
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-9">
                                                ...
                                                <a href="{{route('services.index')}}" class="btn btn-circle grey-salsa btn-outline">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
