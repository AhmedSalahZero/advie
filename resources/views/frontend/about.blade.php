...
{{--        </li>--}}
{{--        <li class="nav-item">--}}
{{--            <a class="nav-link active" href="{{Route('about.index',App()->getLocale())}}">{{__('about')}}</a>--}}
{{--        </li>--}}
...
@section('css')
   ...
   .section-about .heading:before {
             content: "{{__($page->name[App()->getLocale()])}}";
         }
           .owl-stage-outer{height:420px;}
     .banner-bg-one {
         background-image: url({{asset("storage/pages/".$page->banner)}});
     }
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-8 offset-lg-2">
                        <div class="heading text-center mb-5">
                            <h2>{{__($page->name[App()->getLocale()])}}</h2>
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="about-image">
                            <div class="box-img">
                                <img src="{{asset('storage/pages/'.$page->image)}}" alt="about">
                            </div>
                        </div>
                    </div>
                    <!-- about content -->
