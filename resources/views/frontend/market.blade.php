...
@section('navbar')
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="{{Route('markets.show',[App()->getLocale()])}}">{{__('market')}}</a>
        </li>
...
@section('css')
    <style>
        ...
        .banner-bg-one {
            background-image: url({{asset("storage/pages/".$marketPage->banner)}});
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <div class="about-image">
                        <div class="box-img">
                            <img src="{{asset('storage/pages/'.$marketPage->image)}}" alt="about">
                        </div>
                    </div>
                </div>
                <!-- about content -->
                <div class="col-12 col-lg-6">
                    <div class="about-content">
                        ...
                        {!! $marketPage->content[App()->getLocale()] !!}
